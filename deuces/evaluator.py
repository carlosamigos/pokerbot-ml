...
class Evaluator(object):
    ...
    def _two(self, cards):
        ...
        cardString = str(Card.STR_RANKS[firstRank]) + str(Card.STR_RANKS[secondRank])
    ...
    def readInitRanks(self):

        fil = open("startingHandRanks.txt", "r")
        ranks = []
        for line in fil:
            ranks.append(str(line.strip()))
        self.startingHandRanks = ranks
